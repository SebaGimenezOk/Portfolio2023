        ...
        <div name="sobre mi" className='w-full h-screen bg-gradient-to-b from-black to-slate-900 text-white'>
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full '>
                ...
                <p className='text-gray-400 py-6 '>
                    La Segunda Etapa comienza en los años 2007 cuando el hobby de diseñar pasó a ser profesión y desde allí una metamorfosis entre el mundo gráfico y digital.  Me gusta muchísimo crear logotipos, flyers y cartelería. </p>
                <p className='text-gray-400 py-6 '>
